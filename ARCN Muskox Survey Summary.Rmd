...
# dbGetQuery(Connection,"SELECT '# SurveyName = ''' + SurveyName + '''','# ' + Convert(Varchar(3),n) + ' records' as RecordCount FROM Dashboard ORDER BY SurveyName")
# ---------------------------------------------------------------------
# SurveyName = '1983 Seward Peninsula Muskox Survey'	# 0 records			
# SurveyName = '1984 Seward Peninsula Muskox Survey'	# 0 records			
# SurveyName = '1985 Seward Peninsula Muskox Survey'	# 0 records			
# SurveyName = '1988 Cape Krusenstern Muskox Survey'	# 1 records			
# SurveyName = '1988 Seward Peninsula Muskox Survey'	# 0 records			
# SurveyName = '1992 Seward Peninsula Muskox Survey'	# 5 records			
# SurveyName = '1994 Cape Lisburne Muskox Survey'	# 24 records			
# SurveyName = '1996 Seward Peninsula Muskox Survey'	# 0 records			
...
# SurveyName = '2000 Cape Lisburne-Cape Krusenstern Muskox Survey'	# 41 records			
SurveyName = '2000 Seward Peninsula Muskox Survey'	# 132 records			
# SurveyName = '2011 Muskox Population Survey'	# 0 records			
# SurveyName = '2012 Seward Peninsula Muskox Survey'	# 0 records			
# SurveyName = '2013 Seward Peninsula Muskox Population Survey'	# 0 records			
# SurveyName = '2014 Seward Peninsula Muskox Population Survey'	# 0 records			
# SurveyName = '2015 Muskox Survey'	# 0 records
...
Units = o %>% distinct(GMU,Unit) %>%mutate(Unit = as.numeric(Unit))  %>% arrange(GMU,Unit)
```
